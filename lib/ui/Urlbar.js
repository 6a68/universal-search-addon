...
Urlbar.prototype = {
  ...
  onKeyDown: function(evt) {
    ...
    if (evt.ctrlKey || evt.altKey || evt.metaKey) {
      ...
      if (evt.key == 'Enter') {
        if (gURLBar._search && gURLBar._search.term == gURLBar.value) {
          ...
          // XXX oddly it seems that nulling this out causes a previous search page
          //     to be loaded? quite confusing.
