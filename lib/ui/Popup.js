...
Cu.import("resource://gre/modules/SearchSuggestionController.jsm", this);
...
Popup.prototype = {
  ...
  // TODO: clean up. snagged directly from autocomplete.xml
  ...
  _getAutocompleteSearchResults: function() {
    ...
    // TODO: seems like the controller's searchStatus is not a reliable way to decide when/what to send.
